...
if __name__ == "__main__":
    ...
    affectations_etu = gale_shapley_cote_etudiant(PrefEtu, PrefSpe, classement_spe, capacites)
    ...
    affectations_parcours = gale_shapley_cote_parcours(PrefEtu, PrefSpe, classement_etu, capacites)
